...
def sharadar_funds_bundle(environ,
    ...
    #     switch close and closeadj columns, and remove dividends adjustment.
    ...
    print(f"--- Time to ingest bundle: sharadar-funds :{timedelta(seconds=time.time() - start_time)} ---")
        ...
        with zip_file.open(wiki_prices) as table_file:
            ...
            data_table = pd.read_csv(
                ...
                usecols=[
                    ...
                    'volume',
                    'closeadj',
                    ###As of 2021-03-29 'dividends' is in another table(ACTIONS), and has been replaced by 'closeadj',
                    ##'closeunadj',
